...
local TITAN_CURRENCY_VERSION = C_AddOns.GetAddOnMetadata(addonName, "Version");
...
function TitanPanelCurrencyButton_OnLoad(self)
	 ...
	 self.CopperButton.registry = self.registry;
	 self.SilverButton.registry = self.registry;
	 self.GoldButton.registry = self.registry;
